...
#     conn = pymssql.connect("10.62.136.217", "sa", "Passw0rd", "cas-sqldev-tenant-007")
    conn = pyodbc.connect('Trusted_Connection=Yes;DRIVER={SQL Server Native Client 11.0};SERVER=10.62.136.217;DATABASE=cas-sqldev-tenant-007;UID=sa;PWD=Passw0rd')
    cursor = conn.cursor()
