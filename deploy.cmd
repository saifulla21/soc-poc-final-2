...
IF DEFINED KUDU_SELECT_PYTHON_VERSION_CMD (
  ...
  SET PYTHON_EXE=%DEPLOYMENT_SOURCE%\python353x86\python.exe
...
:: 4. Install packages
echo Pip install requirements. install -r requirements.txt
echo requirements.txt
\home\python353x86\python.exe -m pip install --upgrade -r D:\home\site\wwwroot\requirements.txt
IF !ERRORLEVEL! NEQ 0 goto error
